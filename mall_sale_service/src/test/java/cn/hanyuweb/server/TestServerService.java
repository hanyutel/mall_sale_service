 ...
 * 
 */
@WebServiceClient(name = "TestServerService", targetNamespace = "http://server.hanyuweb.cn/", wsdlLocation = "http://192.168.217.1:15555/sayHello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TESTSERVERSERVICE_QNAME = new QName("http://server.hanyuweb.cn/", "TestServerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.217.1:15555/sayHello?wsdl");
    ...
    public TestServer getTestServerPort() {
        return super.getPort(new QName("http://server.hanyuweb.cn/", "TestServerPort"), TestServer.class);
    }
    ...
    public TestServer getTestServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.hanyuweb.cn/", "TestServerPort"), TestServer.class, features);
    }
