...
<body>
			<div class="up">
			<a href="index.do"><img src="images/logo.jpg" height="45px;" class="hy_img"/></a>
			<div class="hy">
				欢迎登录
			</div>
		</div>
		<div class="middle">
			<div class="login">
				...
				<form action="login.do" id="login_form" method="post">
					<div class="input1">
						<input type="text" class="input1_01" name="yh_mch" value="hanyu"/>
					</div>
					<div class="blank_01"></div>
					<div class="blank_01"></div>
					<div class="input2">
						<input type="text" class="input1_01" name="yh_mm" value="123"/>
					</div>
				...
				<div class="box_01">
					<div class="box_01_both">
						<div class="box_01_both_1">数据源1：<input type="radio" name="dataSource_type" checked value="d1"/></div>
